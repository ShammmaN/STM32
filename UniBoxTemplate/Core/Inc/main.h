...
#define B6_EXTI_IRQn EXTI15_10_IRQn
#define LCD_SDA_Pin GPIO_PIN_9
#define LCD_SDA_GPIO_Port GPIOC
#define LCD_SCL_Pin GPIO_PIN_8
#define LCD_SCL_GPIO_Port GPIOA
#define LSM_SCL_Pin GPIO_PIN_6
#define LSM_SCL_GPIO_Port GPIOB
#define LSM_SDA_Pin GPIO_PIN_9
#define LSM_SDA_GPIO_Port GPIOB
