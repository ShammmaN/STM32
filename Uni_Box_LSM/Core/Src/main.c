...
int main(void)
{
  ...
  /*
   * 					Do wykonania zestaw funkcji do obslugi przyciskow ( strzalki oraz +/-)
   *
   * */
...
static void MX_GPIO_Init(void)
{
 ...
 /*Configure GPIO pins : B6_Pin B5_Pin B4_Pin B3_Pin */
  GPIO_InitStruct.Pin = B6_Pin|B5_Pin|B4_Pin|B3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
